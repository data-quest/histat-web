...
class Controller_Table extends Controller_Data {
    ...
    public function action_details() {
        ...
        if ($this->user->has_roles(array('guest')) && $keymask->project->Zugangsklasse !== "-1") $this->redirect(I18n::$lang . '/auth/login');
    ...
    public function action_download() {
        ...
        if (HTTP_Request::POST == $this->request->method()) {
            ...
            if (Kohana::$environment === Kohana::PRODUCTION) {
                $url = 'https://histat.gesis.org/histat/' . I18n::$lang . '/table/' . $type . '/' . $this->id_hs . '/' . $this->filter;
            } else {
