...
class Controller_Cart extends Controller_Table {
    ...
    public function action_delete() {
        ...
        if ($cart->loaded()) {
            $cart->delete();
            $this->redirect(I18n::$lang . '/cart/index/success');
        }
        $this->redirect(I18n::$lang . '/cart/index/error');
    }
