<div id="table_details" >
    ...
    <div class="details" id="tabelle">
        ...
        <div id="scrollX" style="height:auto;overflow-y:hidden;overflow-x: auto;">
            ...
            <div id="scrollY" style="overflow:hidden;overflow-y:scroll;height:100px;background:#ffffff">
                <?php if ($data): ?>
                    <table>
                        <tbody>
                ...
                <?php else: ?>
                    <div style="position: fixed;left:50%;margin-top:10px;margin-left:-250px;width:300px" class="tooltip">
