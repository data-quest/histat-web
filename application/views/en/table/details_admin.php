<div id="table_details" >
    ...
    <div class="details" style="display:none">
        <div class="name" id="tabelle"><div ><?= ($is_admin)? HTML::anchor('table/edit_details/'.$id_hs.'/'.$filter,__('Back'),array('class'=>'edit_table')):''  ?><?= $keymask->Name ?> (Gefundene Zeitreihen: <b><?= $data ? count($keys) : '<span style="color:#FE8F00">' . count($keys) . '</span>' ?></b>)</div> 
