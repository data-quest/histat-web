...
<h3>Citation</h3>
<p class="normal">
    Kindly cite the sources of the used data and the respective publication of the downloaded studies in your own publication according to the scientific conventions. Recommendations regarding the citation of historical data can be found under the topic <?= HTML::anchor('http://www.gesis.org/en/services/data-analysis/daten-historischer-studien/','"Bibliographic citation of research data and study related documents"',array('target'=>'blank'))?>.</p>